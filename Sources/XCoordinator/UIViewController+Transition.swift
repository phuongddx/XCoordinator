...
extension UIViewController {
    ...
    func embed(_ viewController: UIViewController,
        ...
        container.rootContainerView.addSubview(viewController.view)

        // swiftlint:disable force_unwrapping
        NSLayoutConstraint.activate([
            NSLayoutConstraint(item: container.rootContainerView!, attribute: .leading, relatedBy: .equal,
                               toItem: viewController.view, attribute: .leading, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: container.rootContainerView!, attribute: .trailing, relatedBy: .equal,
                               toItem: viewController.view, attribute: .trailing, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: container.rootContainerView!, attribute: .top, relatedBy: .equal,
                               toItem: viewController.view, attribute: .top, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: container.rootContainerView!, attribute: .bottom, relatedBy: .equal,
